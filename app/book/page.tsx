              ...
              <div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    >
                      <div className="bg-emerald-100 text-emerald-600 rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mb-2 mx-auto">HC</div>
                      <div className="font-bold text-center">House Cleaning</div>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <div className="bg-emerald-100 text-emerald-600 rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mb-2 mx-auto">LL</div>
                      <div className="font-bold text-center">Lawn Care</div>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <div className="bg-emerald-100 text-emerald-600 rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mb-2 mx-auto">HS</div>
                      <div className="font-bold text-center">Handyman</div>
                    </button>
                  </div>
                </div>
